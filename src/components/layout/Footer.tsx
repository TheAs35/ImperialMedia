      ...
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-start gap-16 relative z-10">
        <div className="max-w-md">
          <h2 className="font-sans text-4xl mb-6 font-bold tracking-tight">
            ...
            <span className="font-serif italic font-normal text-moss">Nós moldamos mercados.</span>
          </h2>
        ...
        <div className="flex flex-col md:flex-row gap-12 md:gap-24 font-sans text-sm tracking-widest uppercase">
          <div className="flex flex-col gap-4">
            ...
            <a href="#sobre" className="hover:text-moss transition-colors">Sobre Nós</a>
            <a href="#metodo" className="hover:text-moss transition-colors">Método</a>
            <a href="#cases" className="hover:text-moss transition-colors">Cases</a>
            <a href="#servicos" className="hover:text-moss transition-colors">Serviços</a>
          </div>
          
          <div className="flex flex-col gap-4">
            <h3 className="text-cream/40 mb-2">Contato</h3>
            <a href="https://api.whatsapp.com/send/?phone=5511940542386&text&type=phone_number&app_absent=0" target="_blank" rel="noopener noreferrer" className="hover:text-moss transition-colors">
              WhatsApp
            </a>
            <a href="https://instagram.com/imperialmedia" target="_blank" rel="noopener noreferrer" className="hover:text-moss transition-colors">
              Instagram
            </a>
          </div>
        </div>
